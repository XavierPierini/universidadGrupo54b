...
public class FormularioDeInscripcionesView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 117, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Seleccione un Alumno:");
        jLabel2.setFocusCycleRoot(true);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 164, -1, 26));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Listado de Materias");
        jLabel3.setFocusCycleRoot(true);
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(183, 204, -1, -1));
        ...
        getContentPane().add(jRBmatInscriptas, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 251, -1, -1));
        ...
        getContentPane().add(jRBNoIncriptas, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 251, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 291, 555, 137));

        jBinscribir.setBackground(new java.awt.Color(102, 102, 102));
        jBinscribir.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        getContentPane().add(jBinscribir, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 454, 158, -1));

        jBanularInscripcion.setBackground(new java.awt.Color(102, 102, 102));
        jBanularInscripcion.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        getContentPane().add(jBanularInscripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 454, 162, -1));
        ...
        getContentPane().add(jBSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(431, 454, 127, -1));
        ...
        getContentPane().add(CBoxAlumno, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 166, 322, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/FooterUlpVirtualM7.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 111));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/55.jpg"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 590, 400));
